...
public class NetworkUtils {
    ...
    public static void main(String[] args) {
        Set<NetworkInterface> set = getNICs(Filter.PHYICAL_ONLY);
        for(NetworkInterface nif : set) {
            System.out.println(getMacAddress(nif, "-"));
        }
        try {
            getIpv4Address();
        } catch (Exception e) {
    ...
    private static String getIpv4Address() throws Exception {
